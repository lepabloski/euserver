...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.helpers' => 'getApp_HelpersService',
            'app.jwt_auth' => 'getApp_JwtAuthService',
    ...
    /**
     * Gets the 'app.helpers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \EuBundle\Services\Helpers A EuBundle\Services\Helpers instance
     */
    protected function getApp_HelpersService()
    {
        return $this->services['app.helpers'] = new \EuBundle\Services\Helpers($this->get('app.jwt_auth'));
    }

    /**
     * Gets the 'app.jwt_auth' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \EuBundle\Services\JwtAuth A EuBundle\Services\JwtAuth instance
     */
    protected function getApp_JwtAuthService()
    {
        return $this->services['app.jwt_auth'] = new \EuBundle\Services\JwtAuth($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('f6xZIV4DQo', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KideZV3805', 0, 'fDtZv-W9LBY+2Ww4n+jJQB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.1.1.0', 'port' => NULL, 'dbname' => 'appgeopromo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\EuBundle\\Entity'))), 'EuBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('EuBundle' => 'EuBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_add96396bde223dcd43d236514f520b9addd617b1842c6c83af8978d337b72f3');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('pl-wP2Amof', NULL, 'fDtZv-W9LBY+2Ww4n+jJQB', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EuBundle/Resources/views'), 'Eu');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0ceaa1cc81e2a33e00c7aad141113d942b677e55');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qKc+x6DFvm', 0, 'fDtZv-W9LBY+2Ww4n+jJQB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('591dddb7335744.02307488')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'EuBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EuBundle'),
                    'namespace' => 'EuBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '127.1.1.0',
            'database_port' => NULL,
            'database_name' => 'appgeopromo',
            'database_user' => 'root',
            ...
            'secret' => '0ceaa1cc81e2a33e00c7aad141113d942b677e55',
            'locale' => 'es',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '0ceaa1cc81e2a33e00c7aad141113d942b677e55',
